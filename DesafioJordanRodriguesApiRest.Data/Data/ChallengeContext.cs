...
namespace DesafioJordanRodriguesApiRest.Data.Data
{
    public partial class ChallengeContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql("Host=34.72.63.173;Database=challenge;Username=challengeuser;Password=challengepass");
            }
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Compositioncategory>()
            .ToTable("compositioncategory", "public");

            modelBuilder.Entity<Compositionsubcategory>()
           .ToTable("compositionsubcategory", "public");

            modelBuilder.Entity<Currency>()
           .ToTable("currency", "public");

            modelBuilder.Entity<Currencyindicator>()
           .ToTable("currencyindicator", "public");

            modelBuilder.Entity<Financialentity>()
           .ToTable("financialentity", "public");

            modelBuilder.Entity<Funding>()
           .ToTable("funding", "public");

            modelBuilder.Entity<Fundingcomposition>()
           .ToTable("fundingcomposition", "public");

            modelBuilder.Entity<Fundingsharevalue>()
           .ToTable("fundingsharevalue", "public");

            modelBuilder.Entity<Goal>()
           .ToTable("goal", "public");

            modelBuilder.Entity<Goalcategory>()
           .ToTable("goalcategory", "public");

            modelBuilder.Entity<Goaltransaction>()
           .ToTable("goaltransaction", "public");

            modelBuilder.Entity<Goaltransactionfunding>()
           .ToTable("goaltransactionfunding", "public");

            modelBuilder.Entity<Investmentstrategy>()
           .ToTable("investmentstrategy", "public");

            modelBuilder.Entity<Investmentstrategytype>()
           .ToTable("investmentstrategytype", "public");

            modelBuilder.Entity<Portfolio>()
           .ToTable("portfolio", "public");

            modelBuilder.Entity<Portfoliocomposition>()
           .ToTable("portfoliocomposition", "public");

            modelBuilder.Entity<Portfoliofunding>()
           .ToTable("portfoliofunding", "public");

            modelBuilder.Entity<Risklevel>()
           .ToTable("risklevel", "public");
